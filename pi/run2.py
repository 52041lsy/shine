...
class yolov5_lite():
    ...
    def resize_image(self, srcimg, keep_ratio=True):
        ...
        if keep_ratio and srcimg.shape[0] != srcimg.shape[1]:
            ...
            if hw_scale > 1:
                ...
                img = cv2.resize(srcimg, (320,320), interpolation=cv2.INTER_AREA)
    ...
    def detect(self, srcimg):
        ...
        print("Initial outs shape:", outs.shape)
        row_ind = 0
        for i in range(self.nl):
            ...
            try:
                ...
                print(f"outs segment shape: {outs[row_ind:row_ind + length, 0:2].shape}")
                print(f"tiled grid shape: {np.tile(self.grid[i], (self.na, 1)).shape}")
                raise
...
if __name__=='__main__':
    ...
    net = yolov5_lite(modelpath, classfile, confThreshold, nmsThreshold)
